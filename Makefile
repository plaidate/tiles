# Tiles — original 1-bit tile/sprite games on a shared core, built the way
# you'd build for the NES / Game Boy / C64: a fixed tile grid, code-drawn
# tilesets and sprites, and per-game logic on top.
#
...
GAMES := blast spirit relic burrow
